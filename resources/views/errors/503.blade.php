...
<head>
  ...
  <title>Error 404 - Página no encontrada | OyarceGroup</title>
  <style>
...
<body>
  <div class="error-container">
    <h1 class="error-title">Oops! 503 - Service Unaviable</h1>
    <p class="error-message">Server not available.</p>
    <p class="error-contact">Please contact with K&D Latin food Support:<br>
    	<br>
      <a href="mailto:Softwarelab@oyarcegroup.com?subject= 503 - Service Unaviable&body=
