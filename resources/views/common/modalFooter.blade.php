  ...
  Close
        ...
        @if($selected_id < 1)
       <button type="button" wire:click.prevent="Store()" class="btn btn-warning mb-2 mr-2 btn-rounded close-modal">
  ...
  Save
        ...
        @else
        <button type="button" wire:click.prevent="Update()" class="btn btn-outline-primary btn-rounded mb-2 close-modal">
